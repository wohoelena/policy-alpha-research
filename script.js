...
function initLanguageSwitchFallback() {
  ...
  const articleTranslations = {
    "industrial-policy-global-champions.html": {
      en: "industrial-policy-global-champions.html",
      "zh-cn": "zh-industrial-policy-global-champions.html",
      "zh-hant": "zh-hant-industrial-policy-global-champions.html",
      ja: "ja-industrial-policy-global-champions.html",
      ko: "ko-industrial-policy-global-champions.html",
      de: "de-industrial-policy-global-champions.html",
      fr: "fr-industrial-policy-global-champions.html",
    },
    ...
    "netflix-attention-yield.html": {
      ...
      ja: "ja-netflix-attention-yield.html",
      ko: "ko-netflix-attention-yield.html",
      de: "de-netflix-attention-yield.html",
      fr: "fr-netflix-attention-yield.html",
    },
    "inner-infrastructure-gaia.html": {
      en: "inner-infrastructure-gaia.html",
      "zh-cn": "zh-inner-infrastructure-gaia.html",
      "zh-hant": "zh-hant-inner-infrastructure-gaia.html",
      ja: "ja-inner-infrastructure-gaia.html",
      ko: "ko-inner-infrastructure-gaia.html",
      de: "de-inner-infrastructure-gaia.html",
      fr: "fr-inner-infrastructure-gaia.html",
    },
  };
...
zh: {
  label: "最新研究",
  title: "内在基础设施：AI时代的意义经济与 GAIA 案例",
  summary: "当 AI 持续扩大信息供给，注意力、恢复力、信任与意义正在成为更稀缺的经济资源。",
  primary: "阅读文章",
  secondary: "稍后再看",
  article: "zh-inner-infrastructure-gaia.html",
},
"zh-hant": {
  label: "最新研究",
  title: "內在基礎設施：AI 時代的意義經濟與 GAIA 案例",
  summary: "當 AI 擴大資訊供給，注意力、恢復力、信任與意義正在成為更稀缺的經濟資源。",
  primary: "閱讀文章",
  secondary: "稍後再看",
  article: "zh-hant-inner-infrastructure-gaia.html",
},
ja: {
  label: "最新リサーチ",
  title: "内的インフラ：AI時代の意味経済とGAIA",
  summary: "AIが情報供給を拡大するほど、注意、回復、信頼、意味形成は希少な経済資源になります。",
  primary: "記事を読む",
  secondary: "あとで見る",
  article: "ja-inner-infrastructure-gaia.html",
},
ko: {
  label: "최신 리서치",
  title: "내적 인프라: AI 시대의 의미 경제와 GAIA",
  summary: "AI가 정보 공급을 확대할수록 주의력, 회복, 신뢰와 의미 형성은 더 희소한 경제 자원이 됩니다.",
  primary: "글 읽기",
  secondary: "나중에 보기",
  article: "ko-inner-infrastructure-gaia.html",
},
de: {
  label: "Neueste Analyse",
  title: "Innere Infrastruktur: Sinnökonomie im KI-Zeitalter und der Fall GAIA",
  summary: "Je mehr KI das Informationsangebot ausweitet, desto knapper werden Aufmerksamkeit, Erholung, Vertrauen und Sinnstiftung.",
  primary: "Artikel lesen",
  secondary: "Später",
  article: "de-inner-infrastructure-gaia.html",
},
fr: {
  label: "Dernière analyse",
  title: "Infrastructure intérieure : l’économie du sens à l’ère de l’IA et le cas GAIA",
  summary: "À mesure que l’IA accroît l’offre d’information, l’attention, la récupération, la confiance et la construction de sens se raréfient.",
  primary: "Lire l’article",
  secondary: "Plus tard",
  article: "fr-inner-infrastructure-gaia.html",
},
en: {
  label: "New Insight",
  title: "Inner Infrastructure: The Meaning Economy After AI",
  summary: "As AI expands the supply of information, attention, recovery, trust, and meaning are becoming scarcer economic resources.",
  primary: "Read Note",
  secondary: "Later",
  article: "inner-infrastructure-gaia.html",
},
  };
  const insight = localized[languageKey] || localized.en;
  return {
    id: "inner-infrastructure-gaia-20260720",
    ...insight,

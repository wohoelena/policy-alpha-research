...
function getLatestInsight() {
  ...
  const localized = {
    zh: {
      label: "New Insight",
      title: "Musk Stack：从代码到宇宙",
      summary: "政策传导、AI 基础设施与太空经济正在汇入同一个基础设施栈。完整报告已同步发布。",
      primary: "阅读文章",
      secondary: "稍后再看",
      article: "zh-musk-stack-from-code-to-cosmos.html",
    },
    "zh-hant": {
      label: "New Insight",
      title: "Musk Stack：從代碼到宇宙",
      summary: "政策傳導、AI 基礎設施與太空經濟正在匯入同一個基礎設施棧。完整報告已同步發布。",
      primary: "閱讀文章",
      secondary: "稍後再看",
      article: "zh-musk-stack-from-code-to-cosmos.html",
    },
    ja: {
      label: "New Insight",
      title: "The Musk Stack: From Code to Cosmos",
      summary: "Policy transmission, AI infrastructure, and the space economy are converging into one infrastructure stack.",
      primary: "記事を読む",
      secondary: "あとで見る",
      article: "musk-stack-from-code-to-cosmos.html",
    },
    ko: {
      label: "New Insight",
      title: "The Musk Stack: From Code to Cosmos",
    ...
    en: {
      label: "New Insight",
      title: "The Musk Stack: From Code to Cosmos",
      summary: "Policy transmission, AI infrastructure, and the space economy are converging into one infrastructure stack. Full report now available.",
      primary: "Read Note",
      secondary: "Later",
      article: "musk-stack-from-code-to-cosmos.html",
    },
  ...
  return {
    id: "musk-stack-from-code-to-cosmos-20260603",
    ...insight,
